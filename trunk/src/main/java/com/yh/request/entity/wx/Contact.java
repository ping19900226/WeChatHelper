...
public class Contact {
    ...
    private List<Object> menberList;
    ...
    public List<Object> getMenberList() {
        return menberList;
    }
    public void setMenberList(List<Object> menberList) {
    ...
    public int getIsIwner() {
        return isIwner;
    }
    public void setIsIwner(int isIwner) {
        this.isIwner = isIwner;
    }
}

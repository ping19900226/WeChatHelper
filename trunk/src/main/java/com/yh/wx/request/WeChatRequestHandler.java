...
import com.yh.wx.entity.Contact;
import com.yh.common.data.FinalData;
import com.yh.wx.entity.Error;
...
public class WeChatRequestHandler extends RequestHandler {
    ...
    public void getQrcode(String uuid, final Callback<InputStream> callback) throws YHException {
        try {
            ...
            throw new YHException("Get qrcode error: " + e.getMessage(), e);
        }
    }
